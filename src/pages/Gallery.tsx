      ...
      <div className="columns-1 md:columns-2 lg:columns-3 gap-6 space-y-6">
        {items.length > 0 ? items.map((item, idx) => (
          ...
          >
            <img 
              src={item.url} 
              alt={translateText(item.title, currentLang || 'es')}
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-church-navy/90 via-church-navy/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity flex flex-col justify-end p-10 text-white">
               <div className="flex items-center gap-3 mb-3">
                  ...
                  <span className="text-[10px] uppercase font-black tracking-[0.3em] text-slate-300">
               ...
               <h4 className="text-2xl font-serif font-black leading-tight tracking-tight">
