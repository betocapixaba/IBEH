...
export const TRANSLATIONS = {
  es: {
    ...
    knowUs: "Conócenos",
    viewCalendar: "Eventos Especiales",
    sundayWorship: "Servicio Dominical 11:15 AM",
  ...
  en: {
    ...
    knowUs: "About Us",
    viewCalendar: "Special Events",
    sundayWorship: "Sunday Service 11:15 AM",
  ...
  pt: {
    ...
    knowUs: "Quem Somos",
    viewCalendar: "Eventos Especiais",
    sundayWorship: "Serviço de Domingo 11h15",
    sundayServiceLive: "Serviço de Domingo",
    ...
    facebookInvite: "Acompanhe nosso serviço de domingo no Facebook Live. Começa às 11h15.",
  ...
  it: {
    ...
    knowUs: "Chi Siamo",
    viewCalendar: "Eventi Speciali",
    sundayWorship: "Servizio Domenicale 11:15",
    sundayServiceLive: "Servizio Domenicale",
    ...
    facebookInvite: "Segui il nostro servizio domenicale su Facebook Live. Inizia alle 11:15 del mattino.",
  ...
  fr: {
    ...
    viewCalendar: "Événements Spéciaux",
    sundayWorship: "Service du Dimanche 11h15",
...
const TEXT_PHRASE_DICTIONARY: Record<string, Record<LanguageCode, string>> = {
  ...
  "Servicio Principal de Adoración": {
    es: "Servicio Principal de Adoración",
    en: "Main Worship Service",
    pt: "Serviço Principal de Adoração",
    it: "Servizio Principale di Adorazione",
